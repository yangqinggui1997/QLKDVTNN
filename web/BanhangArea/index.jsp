...
<%  response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate"); // HTTP 1.1.
    ...
    String manguoidungbh= (String) session.getAttribute("mand");

if(manguoidungbh != null){
    if(manguoidungbh.substring(0,4).equals("NDQT") || manguoidungbh.substring(0,4).equals("NDKT") || manguoidungbh.substring(0,4).equals("NDTK")){
        out.print("<center><h1 style='color: red;'> Bạn không có quyền thao tác trên khu vực này!</h1></center>");
    }
    else{
        %>
<% request.setAttribute("parent", "parent"); request.setAttribute("banhangarea", "Yang - Trang nhân viên bán hàng");
    %>
